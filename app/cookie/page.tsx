  ...
  return (
    <div className="min-h-screen bg-black text-zinc-300 py-24 px-4 font-sans selection:bg-zinc-800">
      <div className="max-w-3xl mx-auto space-y-8">
        <h1 className="text-4xl font-bold text-white mb-2">Informativa Cookie</h1>
        <p className="text-zinc-500 text-sm">Ultimo aggiornamento: marzo 2026.</p>

        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Cosa sono i cookie?</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Cookie utilizzati da questo sito</h2>
          <p className="mb-4">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-zinc-800">
                  <td className="px-4 py-3 text-white">Cookie tecnici / di sessione</td>
                  <td className="px-4 py-3 text-zinc-400">Funzionamento del sito</td>
                  <td className="px-4 py-3 text-green-500">No (esentati per legge)</td>
                </tr>
                <tr className="border-t border-zinc-800">
                  <td className="px-4 py-3 text-white">Cookie di profilazione</td>
                  <td className="px-4 py-3 text-zinc-400">—</td>
                  <td className="px-4 py-3 text-zinc-500">Non presenti</td>
                </tr>
                <tr className="border-t border-zinc-800">
                  <td className="px-4 py-3 text-white">Pixel / Retargeting</td>
                  <td className="px-4 py-3 text-zinc-400">—</td>
                  <td className="px-4 py-3 text-zinc-500">Non presenti</td>
                </tr>
              </tbody>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Come disabilitare i cookie</h2>
          <p>
