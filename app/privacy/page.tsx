export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-black text-zinc-300 py-24 px-4 font-sans selection:bg-zinc-800">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:info@agrimensore.it" className="text-zinc-400 underline hover:text-white transition-colors">
              info@agrimensore.it
            </a>
            .
          </p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">2. Tipologia di Dati Trattati e Cookie</h2>
          <p className="mb-3">
          ...
          <ul className="list-disc list-inside space-y-3 text-zinc-400">
            <li>
              <strong className="text-zinc-200">Dati forniti volontariamente:</strong> Nome, cognome, e-mail e altre
              informazioni inserite spontaneamente dall&apos;Utente nel modulo di contatto.
            </li>
            <li>
              <strong className="text-zinc-200">Dati di Navigazione e Cookie:</strong> Il presente sito ha natura
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. Finalità, Base Giuridica e Tempi di Conservazione</h2>
          <p className="mb-3">I dati personali conferiti tramite il modulo di contatto sono trattati per:</p>
          <ul className="list-disc list-inside space-y-3 text-zinc-400">
            <li>
              <strong className="text-zinc-200">Finalità:</strong> Fornire riscontro alle richieste di informazioni,
            ...
            <li>
              <strong className="text-zinc-200">Base Giuridica:</strong> Esecuzione di misure precontrattuali adottate
              su richiesta dell&apos;interessato (Art. 6, par. 1, lett. b del GDPR).
            </li>
            <li>
              <strong className="text-zinc-200">Tempi di Conservazione:</strong> I dati saranno conservati per il
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Destinatari dei Dati e Trasferimento Extra-UE</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">5. Diritti dell&apos;Interessato</h2>
          <p className="mb-3">
